...
The following example will clone the "[UART Shell](https://github.com/Infineon/mtb-example-xmc-uart-shell)" application with the desired name "UARTShell" configured for the *KIT_XMC47_RELAX_V1* BSP into the specified working directory, *C:/mtb_projects*:
...
Document title: *CE231961* - *XMC&trade; MCU: UART Shell*
